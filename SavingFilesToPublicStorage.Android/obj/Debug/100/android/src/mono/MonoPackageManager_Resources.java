...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "SavingFilesToPublicStorage.Android.dll" comes first in this list. */
		"SavingFilesToPublicStorage.Android.dll",
		"FormsViewGroup.dll",
		"Plugin.BLE.Abstractions.dll",
		"Plugin.BLE.dll",
		"Plugin.Permissions.dll",
		"SavingFilesToPublicStorage.dll",
